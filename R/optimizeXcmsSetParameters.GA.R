...
optimizeXcmsSetGA <- function(files=NULL, params=getDefaultXcmsSetStartingParamsGA(), parallel=TRUE, run=30, popSize=30, elitism=1, pcrossover=0.8, pmutation=0.2, maxiter=500)
{  
	GA <- ga(type = "real-valued", fitness = fitness, samples=files, startingParam=params,
				...
				run = run, popSize = popSize, elitism = elitism, maxiter = maxiter,
